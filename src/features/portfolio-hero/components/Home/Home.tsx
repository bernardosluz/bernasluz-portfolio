  ...
  return (
    <>
      <section className="relative flex flex-col items-center justify-center min-h-screen text-center px-6 overflow-hidden">
        {/* Glow Effects (Ajustados para brilhar no escuro) */}
        ...
        >
          <header className="space-y-4">
            ...
            <h2 className="text-2xl md:text-3xl font-light text-slate-400">
              {siteConfig.role} <span className="text-slate-700">|</span>{" "}
          ...
          >
            <a
              ...
              className="bg-blue-600 text-white px-8 py-3 rounded-md font-medium hover:bg-blue-500 transition-all transform hover:-translate-y-1 shadow-lg shadow-blue-900/20"
            >
              Entrar em contato
            </a>
